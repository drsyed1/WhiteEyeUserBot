...
""" Plugin By @mrdayamzaidi on telegram """
...
async def univsaye(cowmsg):
    """ For .cowsay module, WhiteEyeUserBot wrapper for cow which says things. """
...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "Hello , User I Am Using [WhiteEyeUserbot](https://github.com/Starkgang/WhiteEyeUserbot) ! Worth A Try 😌"
        )
...
async def react_meme(react):
    """ Make your WhiteEyeUserBot react to everything. """
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"hola"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit("╔┓┏╦━╦┓╔┓╔━━╗\n║┗┛║┗╣┃║┃║X X  ║\n║┏┓║┏╣┗╣┗╣╰╯║\n╚┛┗╩━╩━╩━╩━━╝")
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"plus"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"yes"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"android"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"hmm"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"happybirthday"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"WTF"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"lmao"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"no"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit(
...
\nUsage: UwU\
\n\n.react\
\nUsage: Make your WhiteEyeUserBot react to everything.\
\n\n.slap\
