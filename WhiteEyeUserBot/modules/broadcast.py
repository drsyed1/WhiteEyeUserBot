...
@WhiteEye.on(WhiteEye_on_cmd("bforward ?(.*)"))
@WhiteEye.on(sudo_cmd("bforward ?(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd("broadcast ?(.*)"))
@WhiteEye.on(sudo_cmd("broadcast ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.is_reply:
...
@WhiteEye.on(WhiteEye_on_cmd("badd ?(.*)"))
@WhiteEye.on(sudo_cmd("badd ?(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd("brm ?(.*)"))
@WhiteEye.on(sudo_cmd("brm ?(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd("listchannels"))
@WhiteEye.on(sudo_cmd("listchannels", allow_sudo=True))
